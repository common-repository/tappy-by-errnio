...
define('TAPPY_BY_ERRNIO_VERSION', '1.7');
...
function tappy_by_errnio_uninstall() {
	...
	$plugins = tappy_by_errnio_multiple_plugins();
...
function tappy_by_errnio_load_client_script() {
    ...
    wp_register_script($handle, $script_url, false, TAPPY_BY_ERRNIO_VERSION, true);
...
function tappy_by_errnio_multiple_plugins() {
